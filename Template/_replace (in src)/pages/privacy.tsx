    ...
    <>
      ...
      <div className="flex w-full justify-center p-12">
        <div className="flex max-w-3xl flex-col gap-y-8">
          ...
          <p>
            We at Promptify Corp, LLC (together with our affiliates, Promptify,
            "{NEXT_PUBLIC_SITE_NAME}", “we”, “our” or “us”) respect your privacy
            and are strongly committed to keeping secure any information we
            obtain from you or about you.
          </p>
          <p>
            This Privacy Policy describes our practices with respect to Personal
            Information we collect from or about you when you access
            {NEXT_PUBLIC_SITE_NAME} and its affiliates’ websites (collectively, the
            “Site”), or use {NEXT_PUBLIC_SITE_NAME} and its affiliates’ products and
            services, including application programming interfaces, associated
            software, tools, developer services, data and documentation
          ...
          <>
            ...
            <p>
              We may collect Personal Information if you create an account to
            ...
            <p>
              ...
              Medium, Twitter, YouTube and LinkedIn (“Social Media Pages”). When
            ...
            <p>
              When you visit, use, and interact with the Services, we may
            ...
            <ul>
              <li>
                ...
                Internet Protocol address, browser type and settings, the date
                and time of your request, and how you interacted with the Site.
              </li>
              <li>
                Usage data: We may automatically collect information about your
                use of the Services, such as the types of content that you view
                or engage with, the features you use and the actions you take,
                as well as your time zone, country, the dates and times of
          ...
          <>
            <h2>Cookies:</h2>
            <p>
              We use cookies for login persistence and sending authenticated
              requests to the server. We do not use cookies for analytics or
              user tracking. A “cookie” is a piece of information sent to your
              browser by a website you visit. You can set your browser to accept
              all cookies, to reject all cookies, or to notify you whenever a
              cookie is offered so that you can decide each time whether to
              accept it.
            </p>
            <h2>Analytics:</h2>
            <p>
              We DO NOT use cookies to help us analyse how users use the Site
              and Services and enhance your experience when you use the Site and
              Services. We use the GDPR compliant and "cookie-less" analytics
              platform called Simple Analytics (https://simpleanalytics.com/)
            </p>
            <h2>Online Tracking and Do Not Track Signals:</h2>
            <p>
              ...
              use of the Site. Our Site currently does not respond to “Do Not
              Track” (“DNT”) signals and operates as described in this Privacy
              Policy whether or not a DNT signal is received.
            </p>
            <h2>HOW WE USE PERSONAL INFORMATION:</h2>
            <ul>
              <li>
                To provide, administer, maintain, improve and/or analyse the
                Services;
              </li>
              <li>
                To conduct research, which may remain internal or may be shared
                with third parties, published or made generally available;
              </li>
            ...
            <p>
              ...
              information to analyse the effectiveness of our Services, to
              improve and add features to our Services, to conduct research
              (which may remain internal or may be shared with third parties,
              published or made generally available) and for other similar
              purposes. In addition, from time to time, we may analyse the
              general behaviour and characteristics of users of our Services and
              share aggregated information like general user statistics with
              third parties, publish such aggregated information or make such
              aggregated information generally available. We may collect
              aggregated information through the Services, through cookies, and
              through other means described in this Privacy Policy.
            </p>
            <p>
              {NEXT_PUBLIC_SITE_NAME} uses the following OAuth services for user
              authentication: Google, Twitter, Github. When you sign in using
              any of these OAuth services, we collect and store the following
              information from your account: your name, email address, and
              profile picture. This information is used only for authentication
              purposes and to display your profile picture on your {NEXT_PUBLIC_SITE_NAME}
              profile page. We do not store any other data from your Google
              account.
            </p>
          </>
          ...
          <>
            ...
            <ul>
              <li>
                ...
                we may share Personal Information with vendors and service
                providers, including providers of hosting services, cloud
                services, and other information technology services providers,
                event management services, email communication software and
                email newsletter services, advertising and marketing services,
                and web analytics services. Pursuant to our instructions, these
                parties will access, process, or store Personal Information in
                the course of performing their duties to us.
              </li>
              <li>
                Business Transfers: If we are involved in strategic
                transactions, reorganisation, bankruptcy, receivership, or
            ...
            <p>
              Please contact us at support@{NEXT_PUBLIC_SITE_NAME} if you need to change or
              correct your Personal Information, or if you have any questions or
            ...
            <p>
              ...
              credentials before you can submit a request to know or delete
              Personal Information. If you do not have an account with us, or if
              we suspect fraudulent or malicious activity, we may ask you to
              provide additional Personal Information and proof of residency for
              verification. If we cannot verify your identity, we will not
              provide or delete your Personal Information.
            </p>
            <p>
              Authorised Agents: you may submit a request to know or a request
              to delete your Personal Information through an authorised agent.
              If you do so, the agent must present signed written permission to
              act on your behalf and you may also be required to independently
              verify your identity and submit proof of your residency with us.
            </p>
          </>

          <p>
            Our Service is not directed to children who are under the age of 13.
            {NEXT_PUBLIC_SITE_NAME} does not knowingly collect Personal Information from
            ...
            {NEXT_PUBLIC_SITE_NAME} through the Service please email us at
            support@{NEXT_PUBLIC_SITE_NAME} and we will endeavour to delete that
            information from our databases.
          </p>
          <p>
            The Service may contain links to other websites not operated or
            controlled by {NEXT_PUBLIC_SITE_NAME}, including social media services (“Third
          ...
          <p>
            ...
            reasonable technical, administrative, and organisational measures to
            protect Personal Information both online and offline from loss,
            misuse, and unauthorised access, disclosure, alteration, or
            ...
            settings or security measures contained on the Service, or third
            party websites.
          </p>
          <p>
