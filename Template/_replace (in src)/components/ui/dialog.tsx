...
>(({ className, children, ...props }, ref) => (
  <DialogPortal>
    ...
    >
      {children}
      <DialogPrimitive.Close className="data-[state=open]:bg-accent data-[state=open]:text-muted-foreground absolute right-4 top-4 rounded-sm border-textcolor border-opacity-50 opacity-70 transition-opacity hover:opacity-100 focus:outline-none focus:ring-[1px] focus:ring-textcolor focus:ring-offset-0 disabled:pointer-events-none dark:border-textcolor-dark dark:border-opacity-50 dark:focus:ring-textcolor-dark">
        <X className="h-4 w-4" />
